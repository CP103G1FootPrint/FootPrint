...
public class InfoImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "InfoImageTask";
    private String url;
    ...
    public InfoImageTask(String url, int id, int imageSize) {
    ...
    protected Bitmap doInBackground(Object... params) {
        ...
        jsonObject.addProperty("action", "getInfoImage");
